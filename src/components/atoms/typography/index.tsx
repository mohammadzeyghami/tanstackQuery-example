...
const P = ({ children, className, ...rest }: ParagraphProps) => {
  return (
    <Paragraph
      className={twMerge("!text-black !text-[14px]  ", className)}
      {...rest}
    >
      {children}
    </Paragraph>
...
const H4 = ({ children, className, ...rest }: TitleProps) => {
  return (
    <Title
      level={4}
      className={twMerge("!text-black !text-[18px] !m-0", className)}
      {...rest}
    >
      {children}
    </Title>
...
const H5 = ({ children, className, ...rest }: TitleProps) => {
  return (
    <Title
      level={5}
      className={twMerge(
        "!text-black !text-[16px] md:!text-[18px] lg:!text-[20px]  !m-0",
        className
      )}
      {...rest}
    >
